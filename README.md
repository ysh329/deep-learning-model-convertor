...
|**[ONNX](https://github.com/onnx/onnx)**| None | None | None | None | None | None | [onnx2torch](https://github.com/inisis/onnx2torch) | None | None | None | None | None | None | [X2Paddle](https://github.com/PaddlePaddle/X2Paddle) | - |
...
### [keras-caffe-converter](https://github.com/AlexPasqua/keras-caffe-converter)
...
### [brocolli](https://github.com/inisis/brocolli)
...
### [AlexPasqua/keras-caffe-converter](https://github.com/AlexPasqua/keras-caffe-converter)

It is a both-ways converter between Keras and Caffe. It takes the weights from the `.caffemodel` using [caffe_weight_converter](https://github.com/AlexPasqua/caffe_weight_converter) and generates an equivalent Keras model. It also outputs the Python source code used to generate that Keras model.

### [AlexPasqua/caffe_weight_converter](https://github.com/AlexPasqua/caffe_weight_converter)

This project is used as a part of the previous one on this list: [AlexPasqua/keras-caffe-converter](https://github.com/AlexPasqua/keras-caffe-converter), which is more complete, documented and easy to use. I'd recommend using that one instead.<br>
